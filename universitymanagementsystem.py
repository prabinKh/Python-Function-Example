...
5. Calculate the GPA for a student.

6. View all students and their grades.

7. View all courses and their enrolled students.

8. Calculate the average grade for a course.
"""



# Global variables to store university data
...
def add_course(course_id, course_name, credits):
    if course_id in courses:
        ...
        print(f"Course {course_name} with ID {course_id} and {credits} credits added to the system.")
...
def calculate_gpa(student_id):
    ...
    for course_id, grade in students[student_id]["courses"].items():
    ...
    print(f"GPA for student {students[student_id]['name']}: {gpa:.2f}")
